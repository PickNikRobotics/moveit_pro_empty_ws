...
public:
  /**
   * @brief Constructor for the example_behaviors behavior.
  ...
  /**
   * @brief Implementation of the required providedPorts() function for the example_behaviors Behavior.
   ...
   * @return example_behaviors does not use expose any ports, so this function returns an empty list.
   */
